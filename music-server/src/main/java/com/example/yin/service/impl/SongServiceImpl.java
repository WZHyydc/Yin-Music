...
public class SongServiceImpl extends ServiceImpl<SongMapper, Song> implements SongService {
    ...
    public R addSong(SongRequest addSongRequest, MultipartFile lrcfile,MultipartFile mpfile){
        ...
        String pic = "/img/default/songImage.jpg";
        ...
        String storeUrlPath = "/"+bucketName+"/song/" + fileName;
    ...
    public R updateSongPic(MultipartFile urlFile, int id) {
        ...
        String storeUrlPath = "/"+bucketName+"/img/songPic/" + fileName;
        MinioUploadController minioUploadController = new MinioUploadController();
